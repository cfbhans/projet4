 ...
 * [DEPRECATION] Several route settings have been renamed (the old ones will be removed in 3.0):
   ...
   ```xml
   <route id="chapter_edit" pattern="/chapter/{id}">
   ...
   ```xml
   <route id="chapter_edit" pattern="/chapter/{id}" methods="POST PUT" schemes="https">
       <requirement key="id">\d+</requirement>
   </route>
   ```

...
<h1>Ecrire un nouvel article pour votre blog</h1>
    ...
    <form method="post" action="<?= cf_link('chapters') ?>">
    	<div class="text-left form-group row">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control form-control-sm" name="newPostTitle" id="newPostTitle" placeholder="Titre du chapitre" required />
		    </div>
		</div>
		<div class="form-group">
	    	<label for="newPostContent">Ecrivez votre chapitre</label>
			<textarea id="newPostContent" class="form-control" name="newPostContent"></textarea>

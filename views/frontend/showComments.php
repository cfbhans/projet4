...
<h2>Commentez les chapitres!</h2>

<div id="chapters"class="chapters_id">
            ...
            if($comment->getIsReported() && $comment->getEnum() != "confirmed") { 
                ...
                if(isset($_SESSION['connected'])) {
                    ...
                    <div class="input-group-append">
                        <a id="moderate-comment" class="btn-secondary" type="button" href="<?= cf_link('comments/' . $comment->getId() . '/edit'); ?>">Modérer</a>
